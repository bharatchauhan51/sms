...
public class SmartLightFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        w= inflater.inflate(R.layout.fragment_lamp,container,false);
        String myStr="BHARAT";
...
//        }
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String gardenid=dataSnapshot.child("devId2").getValue().toString();
                topicSub="IOT/SmartHomeSolutions/Lamp/Sub/"+gardenid;
                topicPub="IOT/SmartHomeSolutions/Lamp/Pub/"+gardenid;
